...
namespace paradigm_shift_csharp
{
    public static class CheckerTest
    {
        public static void RunTests()
        {
            ...
            Checker batteryChecker = new Checker(parameterChecker);

            // Temperature Tests
            TestBatteryIsOk_TemperatureOutOfRange_LogsError(batteryChecker);
            TestBatteryIsOk_TemperatureReachingThreshold_LogsWarning(batteryChecker);

            // SOC Tests
            TestBatteryIsOk_SocOutOfRange_LogsError(batteryChecker);
            TestBatteryIsOk_SocReachingThreshold_LogsWarning(batteryChecker);

            // Charge Rate Tests
            TestBatteryIsOk_ChargeRateOutOfRange_LogsError(batteryChecker);
            TestBatteryIsOk_ChargeRateReachingThreshold_LogsWarning(batteryChecker);
        ...
        // Test Cases
        // Temperature Tests
        private static void TestBatteryIsOk_TemperatureOutOfRange_LogsError(Checker checker)
        {
        ...
        private static void TestBatteryIsOk_TemperatureReachingThreshold_LogsWarning(Checker checker)
        {
            var mockLogger = new Mock<IMessageLogger>();
            var parameterChecker = new ParameterChecker(mockLogger.Object);
            var batteryChecker = new Checker(parameterChecker);
        ...
        // SOC Tests
        private static void TestBatteryIsOk_SocOutOfRange_LogsError(Checker checker)
        {
            var mockLogger = new Mock<IMessageLogger>();
            var parameterChecker = new ParameterChecker(mockLogger.Object);
            var batteryChecker = new Checker(parameterChecker);
        ...
        private static void TestBatteryIsOk_SocReachingThreshold_LogsWarning(Checker checker)
        {
            var mockLogger = new Mock<IMessageLogger>();
            var parameterChecker = new ParameterChecker(mockLogger.Object);
            var batteryChecker = new Checker(parameterChecker);
        ...
        // Charge Rate Tests
        private static void TestBatteryIsOk_ChargeRateOutOfRange_LogsError(Checker checker)
        {
            var mockLogger = new Mock<IMessageLogger>();
            var parameterChecker = new ParameterChecker(mockLogger.Object);
            var batteryChecker = new Checker(parameterChecker);
        ...
        private static void TestBatteryIsOk_ChargeRateReachingThreshold_LogsWarning(Checker checker)
        {
            var mockLogger = new Mock<IMessageLogger>();
            var parameterChecker = new ParameterChecker(mockLogger.Object);
            var batteryChecker = new Checker(parameterChecker);
